...
/** 02. Animate
	...
	EXAMPLE USAGE
	<images class="wow fadeInUp" data-wow-delay="0.1s" src="image.jpg" alt="" />
 **************************************************************** **/
	function _animate() {
...
/** 08. Lazy Load
	<images class="lazy" data-original="images/example.jpg" width="765" height="574">
 **************************************************************** **/
	function _lazyload() {
		var _container = jQuery('images.lazy');
		...
		if(jQuery(".masonry-gallery").length > 0) {
			...
			jQuery(".masonry-gallery").each(function() {
				...
				var _firstElemWidth 	= _container.find('a:eq(0)').outerWidth(),
					_bigImageNo 		= _container.attr('data-images-big'),
						...
						if(_id) {
							jQuery('.zoom-more[data-for='+_id+'] a').bind("click", function(e) {
								...
								if(_href != "#") {
									...
									jQuery('figure#'+_id + '>images').fadeOut(0, function() {
										jQuery('figure#'+_id + '>images').attr('src', _href);
									}).fadeIn(500);
							...
							_t.jflickrfeed({
								...
								itemTemplate: '<li>'+
												'<a href="{{image}}" title="{{title}}">' +
													'<images src="{{image_s}}" alt="{{title}}" width="63" height="63" />' +
												'</a>' +
											  '</li>'
							}, function(data) {
								_lightbox();
			...
			loadScript(plugin_path + 'widget.dribbble/jribbble.min.js', function() {
					...
					jQuery.jribbble.shots(_shots).rebounds().then(function(res) {
						...
						res.forEach(function(shot) {
							...
							html.push('<images class="images-responsive" src="' + shot.images.normal + '" alt="image">');
							html.push('</a></li>');
						});
